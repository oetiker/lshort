...
line
\begin{code}
\csi{documentclass}[11pt: vm, twoside: vm, a4paper: vo, article: vm]
\end{code}
...
\mintinline{latex}|\begin{document}| and you are using some package for national language
...
\begin{center}
  \begin{tabular}{@{}lll@{}}
    ...
    \csi{TeX}    & \TeX{}    & Your favorite typesetter \\
...
the document body (\mintinline{latex}|\begin{document}|). It will switch page
...
table rows. One of them is \csi{\textbackslash*} which, similarly to its
...
\end{example}
\end{chktexignore}
In case your grid gets more complicated you may also need the \csi{cline}[a--b: m] %chktex 8
...
instruct \LaTeX{} to only input some of the \mintinline{latex}|\include|d files.
\begin{lscommand}
