...
In certain cases you might want to use the \csi{ProvideDocumentCommand}
...
\csi{begin}[name] and \csi{end}[name] is encountered.
...
\csi{begin}[name] command. This may be especially counter intuitive when we
...
arguments are exactly the same as the \csi{NewDocumentEnvironment} command.
