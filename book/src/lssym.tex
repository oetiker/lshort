...
\begin{table}[!h]
  ...
  \bigskip
  There is no uppercase of some of the letters like \csi{Alpha}, \csi{Beta} and so
...
\begin{table}[!tbp]
  ...
  \bigskip
  You can negate the following symbols by prefixing them with a \csi{not} command.
  \begin{symbols}{*3{cl}}
    \mstX{<}           & \mstX{>}           & \mstX{=}          \\
...
\begin{table}[tbp]
  ...
  \bigskip See \autoref{mathfonts} on \autopageref{mathfonts} for other math fonts.
  \begin{symbols}{@{}*3l@{}}
    \toprule
    Example& Command &Required package\\
    \midrule
    \rule{0pt}{1.05em}$\mathrm{ABCDE abcde 1234}$
    & \mintinline{latex}|\mathrm{ABCDE abcde 1234}|
    &       \\
    $\mathit{ABCDE abcde 1234}$
    & \mintinline{latex}|\mathit{ABCDE abcde 1234}|
    &       \\
    $\mathnormal{ABCDE abcde 1234}$
    & \mintinline{latex}|\mathnormal{ABCDE abcde 1234}|
    &  \\
    $\mathcal{ABCDE abcde 1234}$
    & \mintinline{latex}|\mathcal{ABCDE abcde 1234}|
    &  \\
    $\mathscr{ABCDE abcde 1234}$
    &\mintinline{latex}|\mathscr{ABCDE abcde 1234}|
    &\pai{mathrsfs}\\
    $\mathfrak{ABCDE abcde 1234}$
    & \mintinline{latex}|\mathfrak{ABCDE abcde 1234}|
    &\pai{amsfonts}  or \textsf{amssymb}  \\
    $\mathbb{ABCDE abcde 1234}$
    & \mintinline{latex}|\mathbb{ABCDE abcde 1234}|
    &\pai{amsfonts}  or \textsf{amssymb} \\
    \bottomrule
  \end{symbols}
\end{table}
