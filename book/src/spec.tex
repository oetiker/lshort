...
\begin{lscommand}
  \ci{index}\verb|{|\emph{key}@\emph{formatted_entry}\verb|}|
\end{lscommand}
\noindent commands, where \emph{formatted_entry} will appear in the index
and \emph{key} will be used for soring.  The \emph{formatted_entry} is
...
\verb|\index{Kaese@K\"{a}se}|     &\textbf{K\"ase}, 33& Formatted entry\\ 
