...
So without any further ado, here are the settings you have to put into the preamble of your document
to make it fit for non-english content.
...
Figure~\ref{allinone} on page~\pageref{allinone} shows a sample preamble that takes care of all the necessary settings.
