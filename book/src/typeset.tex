...
You should \emph{never} use the \verb|"| for \wi{quotation marks}
...
The \pai{textcomp} package makes the degree symbol also available under the command
...
If you just need a word or a short phrase in a foreign language you can use the
