...
You should almost never use the \verb|"| for \wi{quotation marks}
...
There is one instance where you should use \verb|"| for quotation marks, and
that is when you need to display a letter with an umlaut. We cover displaying
