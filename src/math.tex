...
number of columns a matrix can have is \(10\).
%$ Consider '\ei{matrix}', instead of 'matrix', above, since the ten-column
%$ limit is specific to the environment, not matrices in general.
\begin{example}
\( \left[
  \begin{matrix}
  1 & 2 \\
...
%$ As far as I know, this is the only way to get a double-struck blackboard
%$ bold 1 for use as an identity symbol (as an alternative to \mathbb{I}); by
%$ kerning a 1 with an l. You can also do this with raw TeX, of course.
\begin{example}
