...
own, there are some areas where it is lacking and some of its choices are
...
the \pai{amsmath} while fixing some of its undesirable behaviours and provides
...
to make them easier to read. The above example should then written like this:
\begin{example}
