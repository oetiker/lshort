...
if typed on a old typewriter (in a monospaced font), with all spaces, and without any \LaTeX{} commands
being executed.
\begin{example}
Use \verb|\LaTeX{}| to
print \LaTeX.
...
such that the results are more in line with todays aestetic assumptions. If you write 
for a publication which has other requirements, like not using any extra packages,
simply do not use the extra commands.
