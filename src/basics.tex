...
%$ No 'other symbols' appear in this subsection.
%$ Perhaps 'Many more other symbols can be printed...'?
...
%$ Should this be '\eei{.pdf}', instead of '\textxx{.pdf}'?
...
command line. %$ ctrl-D: always, or platform dependent?
