...
They are, however, rather ugly, so you may want to add the \cargv{colorlinks}
...
So far we have used the default colors for URLs, hyperlinks. These can be
...
\pai{xcolor} package loaded, you may specify colors the same way as described
